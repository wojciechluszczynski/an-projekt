...
const allProjects = [
  { title: "Złota Harmonia", type: "Mieszkanie", area: 85, location: "Rzeszów", image: vizLivingBeige, href: "/realizacje" },
  { title: "Czarna Perła", type: "Dom", area: 180, location: "Podkarpacie", image: vizKitchenRattan, href: "/realizacje" },
  { title: "Bambusowa Oaza", type: "Salon", area: 65, location: "Małopolska", image: vizDiningFireplace, href: "/realizacje" },
  { title: "Marmurowa Łazienka", type: "Łazienka", area: 12, location: "Krosno", image: vizBathroomMarble, href: "/realizacje" },
  { title: "Ciemna Sypialnia", type: "Sypialnia", area: 20, location: "Rzeszów", image: vizBedroomDark, href: "/realizacje" },
  { title: "Mural Sypialnia", type: "Sypialnia", area: 18, location: "Nowy Sącz", image: vizBedroomMural, href: "/realizacje" },
  { title: "Marmurowa Garderoba", type: "Garderoba", area: 8, location: "Podkarpacie", image: vizClosetMarble, href: "/realizacje" },
  { title: "Detale Ceramiczne", type: "Kuchnia", area: 25, location: "Krosno", image: vizDetailCeramics, href: "/realizacje" },
];
